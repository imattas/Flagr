...
from flagr.monitor import LoggingMonitor, JsonMonitor
from flagr.repl import Repl, ReplMonitor
...
def main():
    ...
    # Build our flagr monitor
    monitor = ReplMonitor()

    # Create our flagr manager
    ...
    parser.add_argument("--flag", "-f", help="set the flag format (e.g. picoCTF{*})")
    parser.add_argument(
        "--force",
        action="store_true",
