...
:class:`flagr.unit.NotEnglishAndPrintableUnit` class, as we can expect
...
:class:`flagr.units.crypto.CryptoUnit` class to ensure it is not a viable
URL or potentially useful file.

.. note::

    This unit **does not recurse**. It simply looks for flags in the output of
    quipqiup's best potential solution. Note that Flagr might find flags
