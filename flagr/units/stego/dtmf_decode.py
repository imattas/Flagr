...
This unit inherits from the :class:`flagr.unit.FileUnit` to ensure
...
from flagr.unit import NotApplicable, FileUnit
...
class DTMFdetector(object):
    ...
    Admittedly, it was found online and adapted to work within Flagr.
    """
...
class Unit(FileUnit):
    ...
    def evaluate(self, case):
        ...
        results = self.detector.getDTMFfromWAV(path)
