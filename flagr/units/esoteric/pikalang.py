...
In the previous framework of Flagr, this unit attempted to decode
...
from flagr.unit import PrintableDataUnit, NotApplicable
from flagr.units.esoteric.brainfuck import evaluate_brainfuck
...
class Unit(PrintableDataUnit):
    ...
    def evaluate(self, case: Any):
        ...
        give the standard output results to Flagr.
