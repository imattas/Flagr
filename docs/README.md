...
You can find Flagr's documentation online and published at 
[https://ctf-flagr.readthedocs.io](https://ctf-flagr.readthedocs.io).

Flagr's documentation is built with [Sphinx](http://www.sphinx-doc.org/).
